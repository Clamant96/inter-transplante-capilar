<section>
    <div class="pagina-servicos">
        ...
        <div class="tipo-servico">
            <div class="img">
                <img src="<?=URL?>/public/img/body_haeir.png" alt="Uso de Pelos Corporais">
            </div>
            <div class="texto">
                <h1>Body Hair no transplante capilar</h1>
                <p>Os pelos de várias regiões do corpo podem ser utilizados no transplante capilar.</p>
                <p>A equipe da Inter Capilar realiza a técnica associado do FUE com body hair retirando unidades foliculares da barba, tórax, abdômen e outras regiões.</p>
                <p>Essas ufs são transplantadas para a região receptora e contribuem para que a cirurgia de transplante capilar tenha resultados exponencialmente maiores e melhores, quanto mais regiões estejam aptas para a retirada dos fios.</p>
            </div>
        </div>
    </div>
</section>
