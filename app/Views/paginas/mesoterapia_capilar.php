<section>
    <div class="pagina-servicos">
        ...
        <div class="tipo-servico">
            <div class="img">
                <img src="<?=URL?>/public/img/transplante_capilar.png" alt="Mesoterapia Capilar">
            </div>
            <div class="texto">
                <h1>Mesoterapia Capilar</h1>
                <p>A mesoterapia capilar é uma terapia de estimulação e nutrição das unidades foliculares que promove a melhora da qualidade, textura e brilho dos fios.</p>
                <ul>
                    <li>
                        <div class="icon">
                        ...
                        <p>Aumenta a densidade e espessura;</p>
                    </li>
                    <li>
                        <div class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-circle-fill" viewBox="0 0 16 16">
